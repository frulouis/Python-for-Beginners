...
# ======================================================================================
# Table Of Content
# Concept 1.3.0: Working with Strings
# Concept 1.3.1: String Concatenations (i.e. joining two or more strings)
# Concept 1.3.2: String Formatting - Printing strings in a new Line
# Concept 1.3.3: Printing strings with double quotes
# Concept 1.3.4: Many string built in functions available in python
# Concept 1.3.5: Stringing together fucntions
# Concept 1.3.6: Checking Strings
# Concept 1.3.7: String arrays and Slicing
# Concept 1.3.8: String placeholders
# Concept 1.3.9: Boolean Strings
# ======================================================================================
